...
$LANG['not_history'] = "暂无浏览记录，点击";
$LANG['enter'] = "进入";
$LANG['scan_goods'] = "浏览商品";
$LANG['view_more'] = "查看更多";
/* 用户菜单 */
...
$LANG['user_service'] = '客户服务';
$LANG['user_service_list'] = '消息中心';
$LANG['user_service_detail'] = '消息详情';
$LANG['user_history'] = '浏览记录';
...
$LANG['delete_booking_success'] = '删除缺货登记成功';
$LANG['booking_number'] = '请输入商品数量';
...
$LANG['pay_desc'] = '描述';
$LANG['pay_fee'] = '手续费';
$LANG['pay_choose'] = '请重新选择支付方式';
$LANG['choose_order'] = '请选择对应的订单';
...
$LANG['del_address_true'] = '删除收货地址成功！';
$LANG['add_address_success'] = '添加新地址成功！';
$LANG['add_address_error'] = '添加新地址失败！';
$LANG['edit_address_success'] = '您的收货地址信息已成功更新！';
$LANG['edit_address_error'] = '您的收货地址信息已更新失败！';
$LANG['address_list_lnk'] = '返回地址列表';
$LANG['add_address'] = '添加地址';
$LANG['edit_address'] = '编辑收货地址';
$LANG['confirm_edit'] = '保存';

$LANG['confirm_drop_address'] = '你确认要删除该收货地址吗？';
$LANG['choose_ship_err'] = '查看支持的配送方式';
...
$LANG['wrong_passwd_question'] = '您输入的问题是错误的';
...
/* 会员订单 */
$LANG['order_list_lnk'] = '全部订单';
$LANG['not_pay_list'] = '未付款';
...
/* 取回密码 */
$LANG['label_get_password'] = '您可通过';
$LANG['photo_number'] = '手机号';
$LANG['safe_question'] = '安全问题';
$LANG['email'] = '电子邮件';
$LANG['get_password'] = '找回密码';
$LANG['reset_password'] = '重置密码';
$LANG['back_home_lnk'] = '返回首页';
$LANG['get_password_lnk'] = '返回获取密码页面';
$LANG['get_password_by_question'] = '问题找回';
$LANG['get_password_by_mail'] = '邮件找回';
$LANG['get_password_by_mobile'] = '短信找回';
$LANG['back_retry_answer'] = '返回重试';
$LANG['no_mobile'] = '请输入手机号码';
$LANG['no_username'] = '请输入用户名';
$LANG['no_emaill'] = '请输入电子邮箱';
$LANG['no_code'] = '请输入验证码';
$LANG['code'] = '验证码';
$LANG['no_password'] = '请输入登录密码';
$LANG['get_code'] = '获取验证码';

/* 登录 注册 */
$LANG['mobile_login'] = '手机注册';
$LANG['emaill_login'] = '邮箱注册';

$LANG['login'] = '登录';
$LANG['sms_code_error'] = '验证码不匹配';
$LANG['mobile_code_error'] = '手机验证码错误';
$LANG['register_back'] = '重新注册';
$LANG['msg_mobile_blank'] = '手机号不能为空';
$LANG['msg_mobile_exists'] = '手机号已存在';
$LANG['next'] = '下一步';
...
$LANG['remember'] = '记住本次登录。';
$LANG['now_landing'] = '立即登录';
$LANG['free_registered'] = '注册';
$LANG['third_login'] = '使用合作账号登录';
$LANG['no_register_auth'] = '还没有注册该插件，请与后台管理员联系';
$LANG['msg_un_blank'] = '用户名不能为空';
$LANG['msg_mast_length'] = '用户名必须为3-15个字符';
...
$LANG['passwd_answer'] = '请输入问题答案';
$LANG['passwd_balnk'] = '密码中不能包含空格';

/* 用户中心默认页面 */
$LANG['user_center'] = '个人中心';
