...
class touch_theme {
	...
	public function __construct($theme_name = '') {
		$this->curr_theme 		= $theme_name ? $theme_name : (ecjia::config('template') ? ecjia::config('template') : RC_Config::system('TPL_STYLE'));
	 ...
	 * 读取橱窗列表
	 */
	public function get_showcase_libraries() {
		$arr_library   = array();
	...
	// 				$file != 'index.htm')
	// 			{
	// 				$available_themes[$file] = new touch_theme($file);
	// 			}
	// 		}
	// 	}
	// 	closedir($theme_dir);
